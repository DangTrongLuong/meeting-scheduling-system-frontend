...
import "../../../styles/Room/EditRoom.css";
...
const EditRoom = () => {
  ...
  const [activeMenuItem, setActiveMenuItem] = useState("rooms");
  ...
  const API_URL = `http://localhost:8080/api/admin/rooms/${id}`;
      ...
      <div className="dashboard-container">
        ...
        <div className="dashboard-content">
          <main className="main-content">
            <div className="meeting-room-loading">Loading room data...</div>
          </main>
        </div>
      </div>
    );
        ...
        <main className="main-content">
          <div className="meeting-room-wrapper">
            <div className="meeting-room-header">
              ...
              <h1 className="meeting-room-h1">Edit Room</h1>
            </div>
