...
function validate() {
  ...
  if (participants && Number(participants) <= 0) arr.push("Số người không hợp lệ");
  return arr;
}
...
async function handleSearch(e) {
  ...
  try {
    ...
    // lọc phòng theo sức chứa + thiết bị
    const filtered = roomsWithDevices.filter((room) => {
      ...
      // ❗ đúng JSON — device nằm trong device.id
